...
// const {productList}  = require('./store')
...
app.get("/product-list/add/:id",(req,res) => {
  const product = productList[+req.params.id]
 axios.post(`http://localhost:8082/cart-list/add`,product).then(status => res.json({update:true}))
})
